...
import com.khz.malekadmin.ui.dashboard.components.DashboardMenuItem
import com.khz.malekadmin.ui.dashboard.components.QuickAccessGrid
import com.khz.malekadmin.ui.dashboard.components.RecentMessagesSection
...
fun DashboardScreen(
    ...
    // هر بار که صفحه داشبورد باز می‌شود (مثلاً بعد از افزودن بازیکن و بازگشت)
    // آمارها به‌صورت پس‌زمینه به‌روز می‌شوند — بدون نمایش اسپینر
    LaunchedEffect(Unit) {
        viewModel.loadDashboardData(silent = true)
    }
