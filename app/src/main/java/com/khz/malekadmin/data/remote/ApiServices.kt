package com.khz.malekadmin.data.remote

import com.google.gson.JsonElement
import com.khz.malekadmin.core.network.ApiResponse
...
interface PlayerApi {
    ...
    suspend fun getPlayerInvoices(@Path("id") id: Int): ApiResponse<com.google.gson.JsonElement>

    @GET("players/{id}/payments")
    suspend fun getPlayerPayments(@Path("id") id: Int): ApiResponse<List<PaymentDto>>

    @GET("players/{id}/balance")
    suspend fun getPlayerBalance(@Path("id") id: Int): ApiResponse<com.google.gson.JsonElement>
