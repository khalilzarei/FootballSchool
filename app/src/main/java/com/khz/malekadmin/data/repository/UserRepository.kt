...
import com.khz.malekadmin.data.dto.request.ResetPasswordRequest
import com.khz.malekadmin.data.dto.request.UpdateUserRequest
import com.khz.malekadmin.data.dto.response.UserDto
import com.khz.malekadmin.data.remote.UserApi
...
class UserRepository(private val api: UserApi) {
    ...
    suspend fun resetPassword(id: Int, password: String? = null): NetworkResult<String?> = try {
        ...
        if (r.success) {
            val newPassword = r.data.unwrap<com.khz.malekadmin.data.dto.response.ResetPasswordResultDto>()?.password
